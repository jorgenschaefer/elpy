...
(defvar elpy-mode-map
  (let ((map (make-sparse-keymap)))
    ...
    (define-key map (kbd "C-c e e") 'elpy-shell-send-statement)
    (define-key map (kbd "C-c e E") 'elpy-shell-send-statement-and-go)
    (define-key map (kbd "C-c e s") 'elpy-shell-send-top-statement)
    (define-key map (kbd "C-c e S") 'elpy-shell-send-top-statement-and-go)
    (define-key map (kbd "C-c e f") 'elpy-shell-send-defun)
    (define-key map (kbd "C-c e F") 'elpy-shell-send-defun-and-go)
    (define-key map (kbd "C-c e c") 'elpy-shell-send-defclass)
    (define-key map (kbd "C-c e C") 'elpy-shell-send-defclass-and-go)
    (define-key map (kbd "C-c e g") 'elpy-shell-send-group)
    (define-key map (kbd "C-c e G") 'elpy-shell-send-group-and-go)
    (define-key map (kbd "C-c e r") 'elpy-shell-send-region-or-buffer)
    (define-key map (kbd "C-c e R") 'elpy-shell-send-region-or-buffer-and-go)
    (define-key map (kbd "C-c e b") 'elpy-shell-send-buffer)
    (define-key map (kbd "C-c e B") 'elpy-shell-send-buffer-and-go)
    (define-key map (kbd "C-c s e") 'elpy-shell-send-statement-and-step)
    (define-key map (kbd "C-c s E") 'elpy-shell-send-statement-and-step-and-go)
    (define-key map (kbd "C-c s s") 'elpy-shell-send-top-statement-and-step)
    (define-key map (kbd "C-c s S") 'elpy-shell-send-top-statement-and-step-and-go)
    (define-key map (kbd "C-c s f") 'elpy-shell-send-defun-and-step)
    (define-key map (kbd "C-c s F") 'elpy-shell-send-defun-and-step-and-go)
    (define-key map (kbd "C-c s c") 'elpy-shell-send-defclass-and-step)
    (define-key map (kbd "C-c s C") 'elpy-shell-send-defclass-and-step-and-go)
    (define-key map (kbd "C-c s g") 'elpy-shell-send-group-and-step)
    (define-key map (kbd "C-c s G") 'elpy-shell-send-group-and-step-and-go)
    (define-key map (kbd "C-c s r") 'elpy-shell-send-region-or-buffer-and-step)
    (define-key map (kbd "C-c s R") 'elpy-shell-send-region-or-buffer-and-step-and-go)
    (define-key map (kbd "C-c s b") 'elpy-shell-send-buffer-and-step)
    (define-key map (kbd "C-c s B") 'elpy-shell-send-buffer-and-step-and-go)
